      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto bg-black/85 backdrop-blur-md">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-[#070e0a]/95 border border-[#27352e] rounded-[32px] p-8 md:p-10 shadow-[0_25px_60px_-15px_rgba(4,120,87,0.25)] overflow-hidden"
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 text-zinc-500 hover:text-white hover:bg-white/5 p-2 rounded-full transition active:scale-95 cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
              ...
              <div>
                ...
                <div className="relative flex items-center bg-[#101412] border border-[#27352e] focus-within:border-emerald-500/40 rounded-xl px-4 py-3 text-zinc-300 transition-all">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full bg-transparent text-sm text-white focus:outline-none placeholder-zinc-60 border-none outline-none leading-none"
                  />
                  <button
                    type="button"
            ...
            <div className="mt-6 pt-5 border-t border-[#27352e]" style={{ transform: 'translateZ(10px)' }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button 
                  ...
                  className="bg-zinc-900 border border-[#27352e] hover:border-emerald-500/40 py-2.5 rounded-xl text-xs text-zinc-300 hover:text-white transition flex items-center justify-center space-x-2 cursor-pointer"
                >
            ...
            {/* Modal Toggles */}
            <div className="mt-8 text-center animate-pulse" style={{ transform: 'translateZ(5px)' }}>
              <button
                type="button"
                onClick={() => {
