...
export default function VoiceSTT({ onCancel, onConfirm }: VoiceSTTProps) {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 15 }}
      className="w-full max-w-3xl mt-12 mb-10 bg-[#070e0a]/95 border border-emerald-500/20 p-6 rounded-[28px] shadow-[0_15px_35px_-10px_rgba(4,120,87,0.3)] backdrop-blur-md flex flex-col justify-between"
    >
      ...
      <div className="h-16 flex items-center justify-center gap-[3px] py-3 bg-[#111c16]/40 rounded-xl border border-white/5 overflow-hidden">
        {bars.map((bar) => {
          ...
          return (
            <motion.div
              ...
              className="w-[3px] bg-zinc-300 rounded-full animate-pulse"
              style={{ minHeight: '4px' }}
            />
          );
        })}
      ...
      <div className="flex items-center justify-between border-t border-white/5 pt-4 mt-2">
        ...
        <button
          type="button"
          className="w-8 h-8 rounded-full bg-[#111c16] border border-[#27352e] hover:border-emerald-500/30 hover:bg-[#182a20] text-zinc-400 hover:text-white flex items-center justify-center transition active:scale-95 cursor-pointer"
        ...
        <div className="flex items-center space-x-3">
          <button
            type="button"
            onClick={onCancel}
            className="w-8 h-8 rounded-full border border-[#27352e] hover:border-emerald-500/30 hover:bg-[#111c16] text-zinc-400 hover:text-white flex items-center justify-center transition active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="w-10 h-10 rounded-full bg-white text-zinc-950 hover:bg-zinc-200 shadow-lg flex items-center justify-center transition transform hover:scale-105 active:scale-95 cursor-pointer"
